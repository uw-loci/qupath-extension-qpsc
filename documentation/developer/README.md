...
| [WORKFLOW_DATA_FLOW.md](WORKFLOW_DATA_FLOW.md) | Per-acquisition-workflow map of what is read, compared, written, and gated. Required reading before changing any workflow's information flow |
