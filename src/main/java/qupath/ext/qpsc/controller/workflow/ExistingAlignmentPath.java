...
public class ExistingAlignmentPath {
     ...
     * {@code (rotated N) (Camera View)} companion) is EMPTY, transform the source macro's
     ...
     *
     * <p>Delegates to the shared {@link AnnotationHelper#bringSourceAnnotationsOntoOpenEntry}
     * so this path and {@code ExistingImageWorkflowV2}'s pre-dialog populate use one
     * implementation of the {@code transform = flip . rotate} composite.
     */
    private java.util.List<PathObject> bringSourceAnnotationsOntoOpenEntry(
        ...
        return AnnotationHelper.bringSourceAnnotationsOntoOpenEntry(gui, project, openEntry, flipX, flipY);
    }
