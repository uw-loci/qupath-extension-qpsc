...
public class AffineTransformationController {
    ...
    /**
     * The tissue search for this slide's first landmark on the 3-point manual route, or null
     * outside an automatic batch. See
     * {@link SlotJumpAutofocus#tissueSearchForFirstLandmark} for why only a first landmark
     * searches.
     */
    private static SlotJumpAutofocus.TissueSearchHint resolveTissueSearch(
        ...
        return SlotJumpAutofocus.tissueSearchForFirstLandmark(
