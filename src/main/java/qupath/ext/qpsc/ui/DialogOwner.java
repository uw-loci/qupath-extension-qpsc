 ...
 * owner.
 *
 * <p>For alerts raised from inside a window that is {@code setAlwaysOnTop(true)}, use
 * {@link UIFunctions#showAlertOverParent} instead -- an alert owned by the main stage still
 * sinks behind an always-on-top parent.
 *
 * <p>Same helper as {@code qupath.ext.dlclassifier.ui.DialogOwner}; keep the two in step.
 */
